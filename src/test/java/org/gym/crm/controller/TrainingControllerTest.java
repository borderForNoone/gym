...
class TrainingControllerTest {
    ...
    void addTraining_shouldReturnOkAndDelegateToFacade() {
        TrainingRequestDTO request = new TrainingRequestDTO(null, null, null, null, null, 0);
    ...
    void addTraining_shouldReturnBadRequest_whenRequiredFieldsMissing() throws Exception {
        ...
        assertThat(errorResponse.getErrorMessage()).contains("traineeId must not be null").contains("trainerId must not be null")
                .contains("trainingTypeName must not be blank");
